...
<script setup lang="ts">
  ...
  // Utility function to format property address
  function formatPropertyAddress (property: PropertyOption, format: 'short' | 'long' = 'short'): string {
    if (format === 'short') {
      return `${property.address_street}${property.address_unit ? ` ${property.address_unit}` : ''}, ${property.address_city}`
    }
    return `${property.address_street}${property.address_unit ? ` ${property.address_unit}` : ''}, ${property.address_city}, ${property.address_state} ${property.address_zip}`
  }
