...
export function useSupabaseBookings () {
  ...
  async function fetchBookings (): Promise<Booking[]> {
    ...
    try {
      ...
      console.error('Supabase booking fetch error:', error_)
      return []
    } finally {
      loading.value = false
    }
  ...
  async function createBooking (formData: BookingFormData): Promise<string | null> {
    ...
    try {
      ...
      console.error('Supabase booking creation error:', error_)
      return null
    } finally {
      loading.value = false
    }
  ...
  async function updateBooking (id: string, updates: Partial<BookingFormData>): Promise<boolean> {
    ...
    try {
      ...
      console.error('Supabase booking update error:', error_)
      return false
    } finally {
      loading.value = false
    }
  ...
  async function deleteBooking (id: string): Promise<boolean> {
    ...
    try {
      ...
      console.error('Supabase booking deletion error:', error_)
      return false
    } finally {
      loading.value = false
    }
