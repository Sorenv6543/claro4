...
REM Verify Chrome is installed at the expected path before attempting to launch.
if not exist "%CHROME_EXE%" (
    echo ERROR: Chrome not found at "%CHROME_EXE%"
    echo Set CHROME_EXE to the correct chrome.exe path and retry.
    exit /b 1
)
